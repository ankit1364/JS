...
var UIController = (function () {
    ...
    return {
        ...
        addListItem: function (obj, type) {
            ...
            //craete HTML string with placeholder text. 
            if (type === 'inc') {
            ...
            //replace placer holder text with actual data.
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function (event) {
        ...
        if (itemID) {
            ...
            //delete the iteam from data structure
            budgetCtrl.deleteItem(type, ID);
            //delete the item from the UI
            UICtrl.deleteListItem(itemID);
            //updat ehe show the new budget 
            updateBudget();
            //calculate and upate percentages
            updatePercentages();
        }
    };
